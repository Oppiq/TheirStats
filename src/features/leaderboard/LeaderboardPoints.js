      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={6}>
          ...
          <Demo>
            <List dense={true}>
              <ListItem>
                <ListItemIcon>{categoryLeaders[0].points}</ListItemIcon>
                <ListItemText
              ...
              <ListItem>
                <ListItemIcon>{categoryLeaders[1].points}</ListItemIcon>
                <ListItemText
              ...
              <ListItem>
                <ListItemIcon>{categoryLeaders[2].points}</ListItemIcon>
                <ListItemText
